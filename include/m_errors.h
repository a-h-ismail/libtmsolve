...
#define UNEXPECTED_COMMA_W_SIMPLE_FUNC "Comma not expected here, this is not a multi-argument function."
...
#define STACK_DEPTH_EXCEEDED "Maximum stack depth was exceeded, aborting..."
