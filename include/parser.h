 ...
 * @param enable_vars Sets support for variables (unknowns) like x.
 ...
 * @param M math_expr being processed.
 * @param s_index Index of the current subexpression.
 * @param enable_vars Toggles support for variable 'x'
 ...
 * @param enable_vars Enables parse time variable (currently x).
