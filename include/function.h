 ...
 */
int tms_derivative(tms_arg_list *L, tms_arg_list *labels, cdouble *result);
 ...
 */
int tms_integrate(tms_arg_list *L, tms_arg_list *labels, cdouble *result);
#endif